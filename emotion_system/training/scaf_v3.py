"""
MOSI 多模態情感分析 v3 — SACF (優化版)
Sentiment-Aware Contrastive Fusion - Optimized

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
基於 scaf_old.py 的優化版本
...
def main():
    print("=" * 70)
    print("MOSI 多模態情感分析 v3 — SACF (優化版)")
    print("Sentiment-Aware Contrastive Fusion - Optimized")
    print("=" * 70)
    print("\n✨ 關鍵優化:")
    ...
    for epoch in range(config["num_epochs"]):
        ...
        if metrics["Acc7"] > best["Acc7"]:
            ...
            }, save_dir / "best_model_v3.pth")
            print(f"  ✅ 新最佳 Acc7={metrics['Acc7']:.2f}%")

    # 測試集
    print("\n" + "=" * 60)
    ckpt = torch.load(save_dir / "best_model_v3.pth", map_location=device, weights_only=False)
    ...
    with open(save_dir / "training_history_v3.json", "w") as f:
    ...
    print(f"模型已儲存至: {save_dir / 'best_model_v3.pth'}")
