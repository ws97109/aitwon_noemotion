...
def main():
    print("=" * 65)
    print("MOSI v40 — Higher LR + 4 Seeds")
    print("=" * 65)
    ...
    import json
    with open(MODEL_DIR/"history_v40.json","w") as f:
        json.dump({"version":"v40","seeds":config["seeds"],
                   "seed_results":seed_results,
                   "ensemble_acc7":round(ens_acc7,2)}, f, indent=2, ensure_ascii=False)
    print(f"結果已儲存至: {MODEL_DIR/'history_v40.json'}")
